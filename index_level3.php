...
// Get level from URL or default to 3
$canteenLevel = isset($_GET['level']) ? (int)$_GET['level'] : 3;
                        ...
                        <div class="category-col">
                            <div class="category-card">
                                <div class="category-card-header">
                                    <div class="category-card-title"><?php echo htmlspecialchars($catName, ENT_QUOTES, 'UTF-8'); ?></div>
                                </div>
                                <div class="menu-list">
                                    <?php foreach ($catItems as $item): ?>
                                        <div class="menu-row">
                                            <span class="menu-name"><?php echo htmlspecialchars($item['name'], ENT_QUOTES, 'UTF-8'); ?></span>
                                            <span class="menu-meta"><?php echo htmlspecialchars($item['unit_num'] . ' ' . $item['unit_type'], ENT_QUOTES, 'UTF-8'); ?></span>
