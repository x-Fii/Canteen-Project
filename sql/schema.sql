...
CREATE TABLE IF NOT EXISTS menu_items (
    ...
    category ENUM('Main Course', 'Dessert', 'Beverage', 'Snacks', 'Sandwiches', 'Desserts') NOT NULL,
...
('Chicken Sandwich', 5.99, 'Sandwiches', 1, 'Freshly made chicken sandwich with lettuce and mayo', TRUE),
('Vegetable Pasta', 7.50, 'Main Course', 2, 'Pasta with seasonal vegetables in a light cream sauce', TRUE),
('Fresh Fruit Salad', 4.25, 'Desserts', 3, 'A mix of seasonal fruits with honey drizzle', TRUE);
